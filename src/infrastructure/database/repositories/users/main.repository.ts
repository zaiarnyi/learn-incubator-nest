  ...
  async deleteAllData() {
    await Promise.all([
      this.dataSource.query(
        `TRUNCATE TABLE users, activate_emails_code, user_security, users_banned,invalid_tokens, comments, blogs, posts, comment_likes  CASCADE;`,
      ),
      this.dataSource.query(
        `TRUNCATE TABLE users, activate_emails_code, user_security, users_banned, invalid_tokens, comments, blogs, posts, comment_likes RESTART IDENTITY;`,
      ),
    ]);
  }
}
