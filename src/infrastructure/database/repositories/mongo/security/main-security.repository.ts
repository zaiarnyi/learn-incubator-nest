...
//   }
//
//   public async deleteCurrent(deviceId: string, userId: string): Promise<DeleteResult> {
//     return this.securityRepository.findOneAndRemove({ deviceId, userId });
//   }
//   public async deleteDeviceForUser(deviceId: string, userId: string): Promise<DeleteResult> {
//     return this.securityRepository.findOneAndRemove({ deviceId, userId });
//   }
//
